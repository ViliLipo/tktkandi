...
SEDA-arkkitehtuurin suurin ero Reactor-malliseen 
palvelimeen on sen hienojakoisempi resurssien ohjaus 
...
haastavalle ja rinnakkaiselle tehtävälle tapahtumankäsittelyssä voidaan
...
Myös suuremmilla tiedostoilla Proactor-toteutus oli säiereservimallin toteutusta nopeampi.
...
Samassa testissä AMPED-toteutus neljällä apuprosessilla
...
osalla oli SYMPED-toteutus, jossa on useita SPED-toteutuksia
omilla säikeillään. Tällä toteutuksella neljällä säikeellä
saavutettiin 440 000 toimitusta sekunnissa 120:nellä asiakkaalla.
