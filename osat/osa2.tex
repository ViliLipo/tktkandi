...
Vertailussa perehdytään Reactor-malliin ja sen jatkokehityksiin,
...
jos Reactor-mallin skaalautuvuus ei muuten riitä.
...
\begin{esim}
 ...
 Prosessi B tarvitsee suoritiuksen aikan resursseja Y ja X. \\
 ...
 \begin{enumerate}
  ...
  \item B -> odota X 
 \end{enumerate}
 päädytään lukkiutumis tilanteeseen, jossa molemmat prosessit
...
yksinkertaisin ja yleinen ratkaisu on tappaa toinen tai molemmat lukkiutuneista prosesseista.
...
Kuvassa 2.1 esitellään miten Reactor-mallin toteuttava verkkopalvelin
vastaa pyyntöön.
...
asiakkaalle.
\begin{center}
    \caption{Kuva 2.1. Pyynnön käsittely Reactor-mallissa}
...
asettaa tapahtumankäsittelijä.
Asynkronisten operaatioiden valmistumisten hallintaa varten
on kehitetty abstraktioita kuten Future/Promise tai async/await.
Nämä abstraktiot laajentavat Reactorin toimintaa osittain vastaamaan
Proactoria, sillä ne tekevät valmistumistapahtumien käsittelemisestä
luontevaa.
...
Proactor-malli siirtää vastuun asynkronisten tapahtumien suorittamisesta
käyttöjärjestelmän vastuulle. Tämä toimintatapa ei kuitenkaan
riitä luomaan mallille selvää kilpailuetua Reactor-malliin. Jos
asynkronisten kutsujen tuki ei olisi kehittynyt riittävän
nopeasti Proactor-malli olisi voinut saada enemmän kiinnostusta.

Reactor-mallin toteuttavalla
